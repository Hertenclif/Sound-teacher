...
namespace Sound_teacher
{
    public partial class FormGuideBasicExercises : Form
    {
        ...
        {
            labelGuideBasicExercisesText.Text = "In this exercise, you need to play 4 frets each string with the pattern: 1, 2, 3, 4 begining " +
                "on the low E string. When you are at the 4th fret of high e string, you should play each string again, begining on the high e string and going upwards " +
        ...
        {
            labelGuideBasicExercisesText.Text = "In this exercise, you need to play 4 frets each string with the pattern: 1, 2, 3, 4, 2, 3, 4, 5, 3, 4, 5, 6 and so on, begining " +
                "on the low E string. When you are at the 9th fret of high e string, you should play each string again, begining on the high e string and going upwards. " +
        ...
        private void buttonGuideBasicExercisesCharmonic_Click(object sender, EventArgs e)
        {
            labelGuideBasicExercisesText.Text = "In this exercise, you need to play the pattern (<STRING>:<FRET>): 1:5, 3:7, 2:7, 4:6, 3:7, 5:5, 4:6, 6:5, 6:9. " +
                "When you reach high e string on 9th fret, you should play the pattern backwards. Very important: you should always play tremolo!";
